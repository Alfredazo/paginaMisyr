...
<section class="carousel slide cid-qOi6lHq3aP" data-interval="false" id="slider1-o">
    <div class="full-screen">
      <div class="mbr-slider slide carousel" data-pause="true" data-keyboard="false" data-ride="carousel" data-interval="6000">
        <div class="carousel-inner" role="listbox">
          <div class="carousel-item slider-fullscreen-image" data-bg-video-slide="false" style="background-image: url(assets/images/camionparallax-1325x745.jpg);">
            <div class="container container-slide">
              <div class="image_wrapper">
                <div class="mbr-overlay" style="opacity: 0;">
                </div>
                <img src="assets/images/camionparallax-1325x745.jpg">
          ...
          <div class="carousel-item slider-fullscreen-image" data-bg-video-slide="false" style="background-image: url(assets/images/prueba5-1325x745.jpg);">
            <div class="container container-slide">
              <div class="image_wrapper">
                <div class="mbr-overlay" style="opacity: 0;">
                </div>
                <img src="assets/images/prueba5-1325x745.jpg">
                <div class="carousel-caption justify-content-center">
          ...
          <div class="carousel-item slider-fullscreen-image active" data-bg-video-slide="false" style="background-image: url(assets/images/prueba1-1032x580.jpg);">
            <div class="container container-slide">
              <div class="image_wrapper">
                <div class="mbr-overlay" style="opacity: 0;">
                </div>
                <img src="assets/images/prueba1-1032x580.jpg">
                <div class="carousel-caption justify-content-center">
                  <div class="col-10 align-center">
                    <h2 class="mbr-fonts-style display-1">
                      VISION
...
<section class="features16 cid-qOib8fYxD4 mbr-parallax-background" id="features16-r">
    ...
    <div class="container align-center">
        <h2 class="pb-3 mbr-fonts-style mbr-section-title display-2">
            Representantes</h2>
        <h3 class="pb-5 mbr-section-subtitle mbr-fonts-style mbr-light display-5">Maestranza Misyr cuenta con un selecto grupo de trabajadores, liderados por las siguientes personas.</h3>
        ...
        <div class="team-item col-lg-3 col-md-6">
                ...
                <div class="item-caption py-3">
                    <div class="item-name px-2">
                        <p class="mbr-fonts-style display-5">Eduardo Opazo R.</p>
                    </div>
                    <div class="item-role px-2">
                        <p>Sub Gerente</p>
                    </div>
